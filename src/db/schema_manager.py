...
class SchemaManager:
    ...
    def make_table_name_from_csv_path(self, source_path):
        """
        Create a safe SQLite table name from the CSV file name.
        Example:
    ...
    def infer_dataframe_schema(self, dataframe):
        """Infer a simple SQLite-style schema from a DataFrame."""
        columns = []
            ...
            columns.append(
                {
                    ...
                    "type": self._infer_sqlite_type(series),
    ...
    def schemas_match(self, left_schema, right_schema):
        """
        Check whether two schemas match by column names and types.
    ...
    def create_table_from_dataframe(
        ...
        """Create a new SQLite table based on the DataFrame schema."""
        self.validate_table_name(table_name)
        ...
        for column in schema["columns"]:
            ...
            column_definitions.append(
                f'"{column["name"]}" {column["type"]}{nullable_sql}'
            )
